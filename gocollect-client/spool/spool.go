...
// snapshots. This is used by "stable" collectors (e.g. app.*) to
...
// the most frequently occurring value as a Collected. Returns nil when
...
func LoadMode(spoolPath, key string, n int) data.Collected {
	...
	// larger string (= more recent, since JSON is compacted).
	var best string
	var bestCount int
